# Vita - Slate Reference Implementation Guidelines

Use this layer with `../DESIGN.md`, `../tokens/vita-slate.tokens.json`, and `../styles/vita-slate-open-design.css` when a prototype needs APEX-compatible implementation details.

## Rules

- Keep the prototype scoped to **Vita - Slate** and `.apex-theme-vita-slate`.
